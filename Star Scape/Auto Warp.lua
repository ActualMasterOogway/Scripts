...
local Ship = game:GetService("Workspace").Ships:WaitForChild(game:GetService("Players").LocalPlayer.Name, 60)
repeat task.wait() until Ship:FindFirstChildWhichIsA("Model") Ship = Ship:FindFirstChildWhichIsA("Model", 60)
