	...
	function windowFunctions:CreateTab(options, ...)
		...
		function tabFunctions:CreateSection(options, ...)
			...
			function sectionFunctions:AddSearchBox(options, ...)
				...
				dropdownSelection.Text = multiselect and typeof(selectedOption) == "table" and unpack(selectedOption) or (passed_multiselect == "string" and multiselect) or tostring((multiselect and (blankstring or "Select Item(s)")) or (selectedOption and tostring(selectedOption)) or blankstring or "No Blank String")
