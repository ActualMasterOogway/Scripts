...
local nodes = {}
local selection
local clonerefs = cloneref or clonereference or function(...) return ... end
...
local function main()
	...
	Explorer.ShowRightClick = function()
		...
		if presentClasses["PVInstance"] or presentClasses["Model"] then
	...
	Explorer.InitRightClick = function()
		...
		context:Register("VIEW_OBJECT",{Name = "View Object (Right click to reset)", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
			...
			for i = 1,#sList do
				...
				if isa(node.Obj,"PVInstance")then
...
Main = (function()
	...
	Main.InitEnv = function()
		...
		env.getcons = getconnections or getsignalcons or get_signal_cons or function(signal: RBXScriptSignal) if typeof(signal) == "RBXScriptSignal" then return {} else return error('connect is not a valid member of '..signal.ClassName..' "'..signal.Name..'"') end end
	...
	Main.Init = function()
		...
		if Main.Elevated then
			...
			Main.RobloxVersion = Main.RobloxVersion or game:HttpGet("https://raw.githubusercontent.com/MaximumADHD/Roblox-Client-Tracker/roblox/version-guid.txt")
		end
