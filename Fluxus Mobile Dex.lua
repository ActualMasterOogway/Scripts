...
return search]==]
	...
	Explorer.InitEntryTemplate = function()
		entryTemplate = create({
			...
			{6,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://15794840773",ImageRectOffset=Vector2.new(304,0),ImageRectSize=Vector2.new(16,16),Name="Icon",Parent={2},Position=UDim2.new(0,4,0,2),ScaleType=4,Size=UDim2.new(0,16,0,16),}},
		})
	...
	Explorer.Init = function()
		Explorer.ClassIcons = Lib.IconMap.newLinear("rbxassetid://15794840773",16,16)
...
--[[
	...
	Final Version
	Developed by Moon
	Modified for Fluxus Mobile by realmasteroogway on discord
